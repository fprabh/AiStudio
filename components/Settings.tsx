...
const Settings: React.FC<SettingsProps> = ({ settings: initialSettings, updateSettings, exportData, importData }) => {
    ...
    const inputClass = "w-24 text-center bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded p-1 shadow-sm focus:ring-brand-red focus:border-brand-red";
    const fullInputClass = "w-full text-left bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded p-1.5 mt-1 shadow-sm focus:ring-brand-red focus:border-brand-red";
        ...
        <div className="max-w-4xl mx-auto space-y-8">
                 ...
                 <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                     <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-300">Product</th>
                                <th className="px-4 py-2 text-center text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-300">Masks/Box</th>
                                <th className="px-4 py-2 text-center text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-300">Boxes/Carton</th>
                                <th className="px-4 py-2 text-center text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-300">Cartons/Pallet</th>
                            </tr>
                        </thead>
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {FINISHED_PRODUCTS.map(product => (
                                <tr key={product.id} className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-800 dark:even:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                                    <td className="px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">{product.name}</td>
                                    <td className="px-4 py-2 text-center"><input type="number" className={inputClass} value={localSettings.productFormulas[product.id].masksPerBox} onChange={e => handleSettingsChange('productFormulas', product.id, 'masksPerBox', parseInt(e.target.value) || 0)} /></td>
                                    <td className="px-4 py-2 text-center"><input type="number" className={inputClass} value={localSettings.productFormulas[product.id].boxesPerCarton} onChange={e => handleSettingsChange('productFormulas', product.id, 'boxesPerCarton', parseInt(e.target.value) || 0)} /></td>
                                    <td className="px-4 py-2 text-center"><input type="number" className={inputClass} value={localSettings.productFormulas[product.id].cartonsPerPallet} onChange={e => handleSettingsChange('productFormulas', product.id, 'cartonsPerPallet', parseInt(e.target.value) || 0)} /></td>
                                </tr>
                            ))}
                        </tbody>
                     </table>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div className="mt-1 relative rounded-md shadow-sm">
                            <input 
                                type="number" 
                                className="w-full text-left bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded p-2 shadow-sm focus:ring-brand-red focus:border-brand-red" 
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input id="masksPerRollMeltblown" type="number" className={fullInputClass} value={localSettings.materialUsage.masksPerRollMeltblown} onChange={e => handleSettingsChange('materialUsage', 'masksPerRollMeltblown', '', parseFloat(e.target.value) || 0)} />
                    </div>
                    <div>
                        ...
                        <input id="masksPerRollBackLayer" type="number" className={fullInputClass} value={localSettings.materialUsage.masksPerRollBackLayer} onChange={e => handleSettingsChange('materialUsage', 'masksPerRollBackLayer', '', parseFloat(e.target.value) || 0)} />
                    </div>
                     <div>
                        ...
                        <input id="masksPerRollOuterL1" type="number" className={fullInputClass} value={localSettings.materialUsage.masksPerRollOuterL1} onChange={e => handleSettingsChange('materialUsage', 'masksPerRollOuterL1', '', parseFloat(e.target.value) || 0)} />
                    </div>
                     <div>
                        ...
                        <input id="masksPerRollOuterL2" type="number" className={fullInputClass} value={localSettings.materialUsage.masksPerRollOuterL2} onChange={e => handleSettingsChange('materialUsage', 'masksPerRollOuterL2', '', parseFloat(e.target.value) || 0)} />
                    </div>
                     <div>
                        ...
                        <input id="masksPerRollOuterL3" type="number" className={fullInputClass} value={localSettings.materialUsage.masksPerRollOuterL3} onChange={e => handleSettingsChange('materialUsage', 'masksPerRollOuterL3', '', parseFloat(e.target.value) || 0)} />
                    </div>
                    <div>
             ...
             <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                 ...
                 <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                     <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-300">Item</th>
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button
                        onClick={exportData}
                        className="flex-1 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-brand-dark hover:bg-brand-gray transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="flex-1 inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600 transition-colors"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
